  ...
  resources: {
    en: {
      translation: {
        ...
        manualsTitle: 'Frequently asked questions',
        manualsErrorMessage: 'An error occurred while trying to get the manuals list.',
        contact: 'Contact us',
    ...
    ru: {
      translation: {
        ...
        manuals: 'Частые вопросы',
        manualsTitle: 'Частые вопросы',
        manualsErrorMessage: 'Произошла ошибка при попытка получения списка файлов.',
